...
phase_names = [
    "2% تحديد الأرض (تحديد الموقع وشراء أو تخصيص الأرض)  ",
    "3% استخراج التراخيص الرخص من البلدية والكهرباء والماء",
    "5% التصميم الهندسي والمعماري (المخططات المعمارية والإنشائية والكهرباء)",
    "8% أعمال الحفر (حفر القواعد، والقبو)",
    "10% صب القواعد والأساسات (قواعد، رقاب، جدران قبو)",
    "25% صب الأعمدة والأسقف والجدران الحاملة (طوابق + أعمدة + جدران حاملة)",
    "12% إغلاق الهيكل بالجدران الداخلية والخارجية (بلوك داخلي وخارجي)",
    "10% تأسيس كهرباء وسباكة (تمديدات أولية، تأسيس المواسير والكابلات)",
    "8% تركيب المصعد والتأكد من الجاهزية (تجهيز البئر، التركيب، التشغيل)",
    "2% إعداد تقرير التسليم (تقرير المهندس، الموافقة النهائية)"
]
